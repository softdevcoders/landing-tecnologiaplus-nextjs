...
export const articulos = [
  {
    "id": 8585,
    "fecha_creacion": "2024-12-11T13:43:00",
    "fecha_modificacion": "2025-09-02T00:00:01",
    "slug": "como-mejorar-servicio-enfermeria-en-geriatricos",
    "enlace_completo": `${routes.blog.children.llamadoDeEnfermeria.url}/como-mejorar-servicio-enfermeria-en-geriatricos`,
    "titulo": "Cómo mejorar el servicio de enfermería en un hogar geriátrico o gerontológico",
    "plantilla": "/llamado-de-enfermeria/html/como-mejorar-servicio-enfermeria-en-geriatricos.html",
    "extracto": "<p>En este artículo te explicamos porque un llamado de enfermeria mejora el servicio en un centro geriátrico, también conocido como hogar de cuidado de ancianos, residencia de ancianos o centro de atención a personas mayores, es una institución especializada en ofrecer atención y cuidado a personas de edad avanzada que necesitan asistencia y supervisión continua&#8230;</p>\n",
    "imagen_principal": {
      "src": "v1756825368/como-mejorar-servicio-enfermeria-en-geriatricos_tt3pzq",
      "alt": null,
      "title": null
    },
    "metadatos": {
  ...
  {
    "id": 10217,
    "fecha_creacion": "2024-12-16T20:59:02",
    "slug": "beneficios-invertir-en-sistemas-de-llamador-de-pacientes",
    "enlace_completo": `${routes.blog.children.llamadoDeEnfermeria.url}/beneficios-invertir-en-sistemas-de-llamador-de-pacientes`,
    "titulo": "Llamador de Pacientes: Conoce los beneficios de invertir en estos sistemas",
    "plantilla": "/llamado-de-enfermeria/html/beneficios-invertir-en-sistemas-de-llamador-de-pacientes.html",
    "extracto": "<p>La eficiencia y la satisfacción del paciente son dos pilares fundamentales para el éxito de cualquier institución de salud. Un sistema de llamador de pacientes se ha convertido en una herramienta esencial para hospitales, clínicas y consultorios, mejorando estos aspectos clave. En Colombia, la adopción de esta tecnología ha crecido rápidamente, demostrando su efectividad y&#8230;</p>\n",
    "imagen_principal": {
      "src": "v1755790917/beneficios-invertir-en-sistemas-de-llamador-de-pacientes_b6ttbt",
      "alt": null,
      "title": null
    },
    "metadatos": {
  ...
  {
    "id": 10529,
    "fecha_creacion": "2025-03-10T14:48:41",
    "slug": "mejora-experiencia-paciente-con-timbre-llamado-enfermeria",
    "enlace_completo": `${routes.blog.children.llamadoDeEnfermeria.url}/mejora-experiencia-paciente-con-timbre-llamado-enfermeria`,
    "titulo": "Mejora la experiencia del paciente con un Timbre de Llamado de Enfermería 🏥",
    "plantilla": "/llamado-de-enfermeria/html/mejora-experiencia-paciente-con-timbre-llamado-enfermeria.html",
    "extracto": "<p>El Estrés del Paciente y la Importancia de una Comunicación Rápida&nbsp; Cuando un paciente ingresa a un hospital o clínica, su estado físico y emocional puede verse afectado por múltiples factores: el dolor, la incertidumbre sobre su condición, la preocupación por los resultados médicos y el ambiente hospitalario en sí mismo. En estos momentos, sentirse&#8230;</p>\n",
    "imagen_principal": {
      "src": "v1747075103/website-v2/blog/llamado-de-enfermeria-cuidamaster/mejora-experiencia-paciente-con-timbre-llamado-enfermeria/tsiffdejmcbp9c833dhe",
      "alt": null,
      "title": null
    },
    "metadatos": {
  ...
  {
    "id": 10542,
    "fecha_creacion": "2025-03-11T15:01:57",
    "slug": "como-llamadores-enfermeria-transforman-hospitales",
    "enlace_completo": `${routes.blog.children.llamadoDeEnfermeria.url}/como-llamadores-enfermeria-transforman-hospitales`,
    "titulo": "🏥 Cómo los Llamadores de Enfermería transforman los hospitales📢",
    "plantilla": "/llamado-de-enfermeria/html/como-llamadores-enfermeria-transforman-hospitales.html",
    ...
    "imagen_principal": {
      "src": "v1747075099/website-v2/blog/llamado-de-enfermeria-cuidamaster/como-llamadores-enfermeria-transforman-hospitales/gms90lhxpci31d37ffa6",
      "alt": null,
      "title": null
    },
    "metadatos": {
  ...
  {
    "id": 10552,
    "fecha_creacion": "2025-03-13T13:45:41",
    "slug": "timbre-para-cama-hospital-atencion-rapida-paciente",
    "enlace_completo": `${routes.blog.children.llamadoDeEnfermeria.url}/timbre-para-cama-hospital-atencion-rapida-paciente`,
    "titulo": "Timbre para Cama de Hospital: Atención rápida y eficaz para el paciente",
    "plantilla": "/llamado-de-enfermeria/html/timbre-para-cama-hospital-atencion-rapida-paciente.html",
    "extracto": "<p>🏥 La Vulnerabilidad del Paciente Hospitalizado Estar hospitalizado es una experiencia desafiante para cualquier persona. La pérdida de autonomía, la incertidumbre sobre su estado de salud y la dependencia del personal médico pueden generar ansiedad y estrés. Muchos pacientes enfrentan dificultades para moverse, lo que les impide pedir ayuda de manera rápida y efectiva cuando&#8230;</p>\n",
    "imagen_principal": {
      "src": "v1747075104/website-v2/blog/llamado-de-enfermeria-cuidamaster/timbre-para-cama-hospital-atencion-rapida-paciente/bmyshz1lqrxmoj2m9kon",
      "alt": null,
      "title": null
    },
    "metadatos": {
  ...
  {
    "id": 10546,
    "fecha_creacion": "2025-03-12T14:43:08",
    "slug": "boton-para-llamar-enfermera-facilita-labor-personal",
    "enlace_completo": `${routes.blog.children.llamadoDeEnfermeria.url}/boton-para-llamar-enfermera-facilita-labor-personal`,
    "titulo": "Cómo un Botón para Llamar a Enfermera facilita la labor del personal de enfermería",
    "plantilla": "/llamado-de-enfermeria/html/boton-para-llamar-enfermera-facilita-labor-personal.html",
    "extracto": "<p>Los Desafíos del Personal de Enfermería en el Día a Día El personal de enfermería es el pilar fundamental en la atención hospitalaria. Son quienes están en primera línea, garantizando el bienestar de los pacientes, administrando medicamentos, supervisando signos vitales y respondiendo a emergencias médicas. Sin embargo, su trabajo no solo implica conocimientos técnicos.</p>\n",
    "imagen_principal": {
      "src": "v1755787958/boton-para-llamar-enfermera-facilita-labor-personal_onwrjh",
      "alt": null,
      "title": null
    },
    "metadatos": {
