            ...
            <div className={style.secondary__products__card}>
              <div className={style.secondary__products__card__image__container}>
                <Image
                  width={800}
                  height={595}
                  src="https://res.cloudinary.com/ddqh0mkx9/image/upload/w_800,f_webp,q_80/v1762341321/localizadores_restaurantes_cir_resistentes_agua"
                  alt="Localizador para clientes modelo CIR C2 junto a su base de carga"
                  title="Localizador CIR C2 para clientes con base de carga"
                  unoptimized={true}
                />
              ...
              <div className={style.secondary__products__card__content}>
                <h3 className={style.secondary__products__card__title}>Cir Resistente <br /> al agua</h3>
                <Link
                  className={style.secondary__products__card__btn}
                  href={routes.landings.localizadoresParaRestaurantes.children.localizadoresCirResistenteAlAgua.url}
                >
                  Ver más
                </Link>
                <p className={style.secondary__products__card__text}>862 vendidos</p>
              </div>
            </div>
          </div>
